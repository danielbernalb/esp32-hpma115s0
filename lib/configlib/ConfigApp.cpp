...
void ConfigApp::reload(){
  ...
  dname = preferences.getString("dname","PM2.5_BOG_USM_Marichuela_E02");
  // wifi settings
  wifiEnable = preferences.getBool("wifiEnable",true);
  ssid = preferences.getString("ssid","Ballesteros");
  pass = preferences.getString("pass","175037091NORMANJB");
